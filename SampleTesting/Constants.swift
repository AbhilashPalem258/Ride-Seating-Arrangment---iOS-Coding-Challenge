...
struct SeatingViewControllerConstants {
    ...
    struct colors{
        static let aisle = UIColor.init(red: 79/255, green: 129/255, blue: 189/255, alpha: 1.0)
        static let window = UIColor.init(red: 155/255, green: 187/255, blue: 89/255, alpha: 1.0)
        static let middle = UIColor.init(red: 192/255, green: 80/255, blue: 77/255, alpha: 1.0)
    }
}

//MARK: - SeatingArrangementContsnats
struct SeatingArrangementContsnats{
    static let seatsCapacityArr: [(Int, Int)] = [(3,12),(4,12), (3,12)]
